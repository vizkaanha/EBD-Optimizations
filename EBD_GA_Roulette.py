...
# GA settings.
POP = 80   # Larger population for roulette
GEN = 70   # More generations
CXPB = 0.70
MUTPB = 0.35
...
for Xa in X:
    ...
    # Roulette Wheel Selection for comparison study
...
print("Selection Method : Roulette Wheel Selection")
print("Compare SIC, PASS points and execution time with Tournament method.")
